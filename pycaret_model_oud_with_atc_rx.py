...
def main():
    """
    Load features from CSV and train/evaluate multiple classifiers using PyCaret on two targets:
    ...
    for target in targets:
        ...
        # Save the model
        model_name = f"best_model_{target.replace('_', '_')}"
